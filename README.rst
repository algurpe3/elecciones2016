Sample Django web application about spanish 2016 Elections based on:
	- |task-boiler-repo|.

.. |task-boiler-repo| raw:: html
	
	<a href="https://github.com/mineta/taskbuster-boilerplate/"
    target="_blank">TaskBuster Django Project Boilerplate</a>

	- and its associated |task-boiler-tutorial|.

.. |task-boiler-tutorial| raw:: html

	<a href="http://www.marinamele.com/taskbuster-django-tutorial/"
...
Welcome to Elecciones' documentation!
======================================
...
Some of the Elecciones Django Project Boilerplate functionalities are:
...
in the |elecciones_tutorial|. There you can learn, step by step, how
Elecciones has been done, and even do it yourself if you want to!!

.. |elecciones_tutorial| raw:: html

    <a href="http://marinamele.com/taskbuster-django-tutorial"
    target="_blank">Elecciones Django Tutorial</a>
...
This file describes the Elecciones project and then, after the toctree directive, we are including two different files: *requirements.rst* and *quick_start.rs*, which are not yet created.
...
This project is named *Elecciones*, so if you are using this
Boilerplate to create your own project, you'll have to change
the name in a few places:

 - *EleccionesProject* **folder** (your top project container)
 - *EleccionesProject/elecciones* **folder** (your project name)
 - virtual environment names: **tb_dev** and **tb_test** (name them whatever you want)
 - in virtual environments **postactivate** files (see section below), you have to change **elecciones.settings.development** for your **projectname.settings.development**. Same works for the testing environment.
...
You must add the lines: ::
	...
	$ export DJANGO_SETTINGS_MODULE="elecciones.settings.development"
...
where you have to add the lines::
	...
	$ export DJANGO_SETTINGS_MODULE="elecciones.settings.testing"
	$ export SECRET_KEY="your_secret_django_key"
...
Go to the terminal, inside the *EleccionesProject* folder and create the files to translate with::
...
Next, go to the *locale* folder of your language::
	...
	$ cd elecciones/locale/ca/LC_MESSAGES

where *elecciones* is your project folder. You have to edit the file *django.po* and translate the strings. You can find more information about how to translate the strings |translation_strings_post|.
...
- in **test_internationalization**, update your languages with the translation of title text, here "Welcome to Elecciones 2016!"
